...
const STYLE = defineStyle({
  ...
  fonts: {
    zh: { head: { f: '"Noto Serif SC","Songti SC",serif', w: 900 }, body: { f: '"Noto Serif SC",serif', w: 700, also: [500] }, shout: { f: '"Noto Serif SC",serif', w: 900 }, latin: { f: '"Cinzel","Noto Serif","Noto Serif SC",serif', w: 700, ls: .06 }, mono: { f: '"IBM Plex Mono","Noto Serif SC",monospace', w: 500 }, sub: { f: '"Noto Serif SC",serif', w: 500, also: [700, 900] } },
    ja: { head: { f: '"Noto Serif JP","Hiragino Mincho ProN",serif', w: 900 }, body: { f: '"Noto Serif JP",serif', w: 700, also: [500] }, shout: { f: '"Noto Serif JP",serif', w: 900 }, latin: { f: '"Cinzel","Noto Serif","Noto Serif JP",serif', w: 700, ls: .06 }, mono: { f: '"IBM Plex Mono","Noto Serif JP",monospace', w: 500 }, sub: { f: '"Noto Serif JP",serif', w: 500, also: [700, 900] } },
